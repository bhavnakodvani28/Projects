...
$sql= "select * from packagetransaction where uid=$_SESSION[userid]";
$result= mysqli_query($cn,$sql);
...
$sql1= "select * from packagedetail where pkid='$row[pkid]'";

$result1=mysqli_query($cn,$sql1);
$packagedetail= mysqli_fetch_array($result1);

$sql3="select ufname,ulname from usermaster where userid=(select uid from trainermaster where trainerid = $row[trainerid])";
$result3=mysqli_query($cn,$sql3);


$sql4="select fname from foodmaster where fid IN (select fid from dietfood where dietfoodid IN(select dietfoodid from dietfood where uid=$_SESSION[userid]))";
$food=mysqli_query($cn,$sql4);


//$trainer=mysqli_fetch_array($result3);


   echo"<tr>";
   echo "<th>Package Name</th>";
   echo"<td>${packagedetail['pkname']}</td></tr>";
   echo "<tr><th>Price</th>";
   echo"<td>${packagedetail['pkprice']}</td></tr>";
