...
<body>
      ...
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
		 ...
		 <!---728x90--->
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">SHOP HERE </h3>
			<!---728x90--->
			<div class="text-center wls-hours-list" style="text-align: center;">

<?php
if(isset($_SESSION['user']))
{
   echo "<form action='review_user_selection.php' method='post'>
<label class='text-left mb-lg-5 mb-md-4 mb-sm-4 mb-3'>Select Your Desired Items:</label><br>";
	$cn=mysqli_connect("localhost","root","","focusdb");
	$list=mysqli_query($cn,"select * from productdetail p1 join producttype p2 where p1.prtypeid = p2.prtypeid");
	echo "<table class='table table-bordered table-hover'><tr><th>Action</th><th>Product</th><th>Price</th><th>Category</th></tr>";
	while($row=mysqli_fetch_array($list, MYSQLI_ASSOC))
	{
		echo "<tr><td style=\"vertical-align:middle\";><input class='form-check-input' type='checkbox' name='check_list[]' value='".$row['prtypeid']."'></td><td style=\"vertical-align:middle\";><img width='300px' src=".$row['imagepath']."><br><br>".$row['prname']."</td><td style=\"vertical-align:middle\";>₹".$row['prprice']."</td><td style=\"vertical-align:middle\";>".$row['prtypename']."</td></tr>";
	}
	echo "</table>";
   echo "<button class='btn btn-success' type='submit' name='submit'>Submit</button";
}
 else{
   echo "<h1>You must be logged in to view this content.<br><br><a href='index.php#log'>Go to Homepage.</a>";
}
?>
<br><br>
