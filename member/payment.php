...
<body>
      ...
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
		 ...
		 <!---728x90--->
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Your Package Details </h3>
			<!---728x90--->
			<div class="wls-hours-list" style="text-align: center;">
<?php
$cn= mysqli_connect("localhost","root","","focusdb") or die(mysqli_error());
$pk_row = mysqli_fetch_array(mysqli_query($cn, "SELECT * FROM packagedetail WHERE pkid = {$_GET['pkid']}"));

echo "<table cellpadding='10' border='0' class='table table-hover'><tr><th> Name </th><td>".$pk_row['pkname']."</td></tr><tr><th> Month </th><td>".$pk_row['pkmonth']."</td></tr><tr><th> Price </th><td>₹".$pk_row['pkprice']."</td></tr></table><br><br><button class='btn btn-success' onclick=\"window.location.href='payment_gateway.php?pkid={$_GET['pkid']}';\" >Proceed</button><br><br><br>";
?>
</div>
