...
<body>
      ...
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
		 ...
		 <!---728x90--->
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">YOUR SELECTION</h3>
			<!---728x90--->
...
<?php
	...
	if(isset($_POST['submit']))
	{
		if(!empty($_POST['check_list']))
		{
			...
			echo "You have selected following ".$checked_count." product(s):<br>";
			...
			{
				$list = mysqli_query($cn, "select * from productdetail where prtypeid=".$selected."");
				$show = mysqli_fetch_array($list);
				echo "<tr><td><img width='24' height='24' src=".$show['imagepath']."><br><br>".$show['prname']."</td><td>".$show['prprice']."</td></tr>";
				@$price += $show['prprice'];
			}
			$_SESSION['prdids']=$_POST['check_list'];
			echo "</table><br><br><h1>Grand total is : ".$price."</h1><br><br><button class='btn' onClick='window.location.href = \"payment_gateway.php\";'>Proceed =></button>";
		}
		else
		{
			echo "<b>Please select atleast one product.</b>";
		}
	}
?>
			</div>
