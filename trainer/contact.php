           ...
           if(isset($_SESSION['trainer']))
           {
             ...
             echo "<li class='nav-item dropdown'>
                      ...
                      <div class='dropdown-menu' aria-labelledby='navbarDropdown'>
                            <a class='dropdown-item' href='trainer/dietfood.php'>Diet Food</a>
                            <a class='dropdown-item' href='trainer/dietmember.php'>Diet Member</a>
                            <a class='dropdown-item' href='trainer/attend_tran.php'>Attendence</a>
                            <a class='dropdown-item' href='trainer/schedule_mov.php'>Schedule</a>
                        </div>
                     </li>";
           }
           ?>     
