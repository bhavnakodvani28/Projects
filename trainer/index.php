      ...
      <div class="col-md-5 mx-auto">
        <div class="myform form ">
           <div align="center" class="logo mb-3" class="col-11" >
            <p class="font-italic" align="center" > <font size="60">Login</font></p>
          </div> 
...
KEEP CALM AND WORK HARD</h4>
  ...
  <select id="utype" name="utype" class="form-control">
    ...
    <div class="form-row">
	<div class="form-group col-md-6 col-sm-6 fill-all-form">
      <input type="text" name="name" id="name" class="form-control" required="required" placeholder="Name" onkeypress="return chkAplha(event,'error')" onblur="chkblnk('fn','error')">
    </div>
     <div class="form-group col-md-6 col-sm-6 fill-all-form">
