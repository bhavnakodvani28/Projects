...
<body>
               ...
               <div class="collapse navbar-collapse  nav-fill " id="navbarSupportedContent">
                  <ul class="navbar-nav nav-pills nav-fill">
                   ...
                   <?php
                     ...
                     {
                        ?>
                        <a href="#log" class="nav-link active">SignIn</a>
                        <?php
                     }
                  ?>
               </li>
      ...
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            <ul class="short_ls">
               <li>
                  <a href="index.php" class="fa fa-home fa-fw" >Home</a>
               </li>
    <li></li>
    <li></li>
    <li></li>
  ...
  <div align="center">
    ...
    <form method="POST" action="./user_dashboard.php">
      ...
      <i class="fa fa-user fa-lg" id="emailid"></i>
      

      <input type="password" name="passsword" placeholder="Password" />
      <i class="fa fa-lock fa-lg" id="passsword"></i>
      <button type="submit" id="btnSgn">Sign In</button>
      <button type="reset" id="btnRst">Reset</button>
    </form>
    <a class="btn sent-butnn btn-lg" href="./forgot password.html" id="forgotLink">Forgot Password</a>
  </div>
</section>
      
    <a class="btn sent-butnn btn-lg" href="./index.php">Have'nt Registered Yet?</a>
  </div>
