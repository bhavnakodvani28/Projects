...
<?php
	...
	echo "<table class=\"table\"><tr><th>Action</th><th>Product</th><th>Price</th><th>Category</th></tr>";
	while($row=mysqli_fetch_array($list, MYSQLI_ASSOC))
	{
		echo "<tr><td><input type='checkbox' name='check_list[]' value='".$row['prtypeid']."'></td><td><img src=".$row['imagepath']."><br><br>".$row['prname']."</td><td>".$row['prprice']."</td><td>".$row['prtypename']."</td></tr>";
	}
	echo "</table>";
?>
<br><br>
