...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/31-07-2018/trim_fit-demo_Free/621294470/web/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Dec 2018 16:48:06 GMT -->
         ...
         <div class="header-w3layouts">
           ...
           if(isset($_SESSION['admin']))
           {
             ...
             echo "<li class='nav-item dropdown'>
                      ...
                      <div class='dropdown-menu' aria-labelledby='navbarDropdown'>
                            <a class='dropdown-item' href='admin/packagetype.php'>Types of Packages</a>
                            <a class='dropdown-item' href='admin/package.php'>Edit Package</a>
                            <a class='dropdown-item' href='admin/producttype.php'>Type of Products</a>
                            <a class='dropdown-item' href='admin/product.php'>Edit Products</a>
                                <a class='dropdown-item' href='admin/trainer.php'>Edit Trainers</a>
                            <a class='dropdown-item' href='admin/member.php'>Edit Members</a>
                            <a class='dropdown-item' href='admin/food.php'>Edit Food Items</a>
                            <a class='dropdown-item' href='admin/diet.php'>Edit Diet</a>
                            <a class='dropdown-item' href='admin/equipment.php'>Edit Equipments</a>
           ...
           ?>       
                   ...
                   <?php
                     ...
                     {
                        ?>
                        <a class="nav-link"  href="admin_profilee.php"><?php echo $_SESSION['user']; ?></a>
                         <li class="nav-item">
            ...
            <div class="agile-info-para">
               <div class="row contactright pb-lg-5 pb-md-4 pb-sm-3 pb-3">
                  <div class="col-lg-4 col-md-4  text-center contact-address-grid">
                     <div class="footer_grid_left">
                        ...
                        <p>Bopal-Ghuma,Ahmedabad, <br>India .</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-4 text-center contact-address-grid">
                     <div class="footer_grid_left">
                        ...
                        <p>+(91)90679993565 <br>+(91) 123 4565 354</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-4 text-center contact-address-grid">
                     <div class="footer_grid_left">
                        ...
                        <p><a href="mailto:info@example.com">focusthegym@gmail.com</a> 
                           <br><a href="mailto:info@example.com">shivamvyas@gmail.com</a>
                        </p>
                     </div>
                  </div>
               </div>
               <div class="row contact-wls-detail">
                  ...
                  <div class="col-lg-6 address_mail_footer_grids">
                     <iframe src="https://www.google.com/maps/embed?origin=mfe&pb=!1m2!2m1!1s%5Bbopal%5D"></iframe>
                  </div>
               </div>
            </div>
			<!---728x90--->
