...
KEEP CALM AND WORK HARD</h4>
  ...
  <div class="form-row">
   ...
   <div class="form-row">
    ...
    <div class="form-group col-md-2 col-sm-2 fill-all-form">
      <input type="text" name="bloodgroup" id="bloodgroup" class="form-control" placeholder="bloodgroup" required="required">
    </div>
  </div>
   <div class="form-row">
    <h4>DOB</h4>
    <div class="form-group col-md-2 col-sm-2 fill-all-form">
      <input type="date" name="dob" id="dob" value="2019-02-24" required="required">
    </div>
  </div>
