...
<body>
      ...
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
       ...
       <!---728x90--->
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Hello <?php echo $_SESSION['admin']; ?></h3>
         <!---728x90--->
        
               <?php
$cn= mysqli_connect("localhost","root","","focusdb") or die(mysqli_error());
$sql= "select * from usermaster where userid=$_SESSION[userid]";
