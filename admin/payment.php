...
<?php
echo "<table cellpadding='10' border='0'><tr><th> Name </th><td>".$_GET['name']."</td></tr><tr><th> Month </th><td>".$_GET['month']."</td></tr><tr><th> Price </th><td>".$_GET['price']."</td></tr></table><br><br><button class='btn' onClick='window.location.href = \"payment_gateway.php\";'>Proceed =></button><br><br><br>";
?>
</div>
