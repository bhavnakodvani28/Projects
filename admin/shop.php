...
<form action="review_user_selection.php" method="post">
...
<?php
	...
	echo "<table><tr><th>Action</th><th>Product</th><th>Price</th><th>Category</th></tr>";
	while($row=mysqli_fetch_array($list, MYSQLI_ASSOC))
	{
		echo "<tr><td><input type='checkbox' name='check_list[]' value='".$row['prtypeid']."'></td><td><img width='24' height='24' src=".$row['imagepath']."><br><br>".$row['prname']."</td><td>".$row['prprice']."</td><td>".$row['prtypename']."</td></tr>";
	}
	echo "</table>";
?>
<br><br>
...
<!----- Including PHP Script ----->
			...
			<?php
				...
				if(mysqli_num_rows($result) > 1)
				{
					...
					{
						echo "<tr>";
						echo "<td><a href='payment.php?name=".$row['pkname']."&month=".$row['pkmonth']."&price=".$row['pkprice']."'>".$row['pkname']."</a></td>";
