         ...
         <div class="header-w3layouts">
           ...
           if(isset($_SESSION['admin']))
           {
             ...
             echo "<li class='nav-item dropdown'>
                      ...
                      <div class='dropdown-menu' aria-labelledby='navbarDropdown'>
                            ...
                            <a class='dropdown-item' href='admin/exercisemov.php'>Edit Exercise Movements </a>
                            <a class='dropdown-item' href='admin/schedule.php'>Edit Schedule</a>
           ...
           ?>       
                   ...
                   <?php
                     ...
                     {
                        ?>
                        <a href="signin.php" class="nav-link active">SignIn</a>
                        <?php
                     }
                  ?>
               </li>
